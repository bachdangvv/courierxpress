...
const YellowButton = ({
    ...
    const variantStyles = {
        primary: 'font-semibold w-full md:w-[145px] h-auto rounded-[25px] opacity-100 hover:border hover:opacity-[0.85] transition-500 border border-amber-400 bg-amber-400 p-2 px-4',
