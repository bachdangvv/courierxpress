...
import AdditionalContactsData from '../../../data/SupportFAQ/additionalcontacts.json';
import cn from 'classnames';

const AdditionalContactRender = () => {
    ...
    return (
        ...
        <div className='w-full h-full max-w-[1000px] flex flex-col justify-center items-center'>
            {AdditionalContactsData.map((data) => {
...
export default AdditionalContactRender;