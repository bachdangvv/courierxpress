...
export default function Home() {
    ...
    return (
        <>
        <section className='home-hero-container flex justify-center items-center w-screen h-[300px] md:h-[450px]'>
            <div className='hero-content h-full w-full max-w-[1400px] lg:grid lg:grid-cols-[4fr_1fr] md:grid md:grid-cols-[1fr] items-center text-center gap-3 md:p-8 mx-auto'>
                <div className='left-hero-container flex flex-col justify-center items-start gap-2'>
                ...
                <div className='right-hero-container flex justify-center items-end w-full h-full'>
                    <img
                        className='hero-person-img w-full h-full max-w-[400px] max-h-[400px]'
                        src={heroPerson}
                    />
                </div>
            </div>
